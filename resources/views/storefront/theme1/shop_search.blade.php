                    ...
                    <div class="col-12 col-xl-12">
                        <div class="shop-right-sidebar">
                            ...
                            <div class="text-center mt-4">
                                <button id="load-more" class="btn btn-light" data-url="{{ route('merchant.store.shop.search', ['subdomain' => $subdomain,'search'=>$query]) }}">Load More</button>
                            </div>
                        </div>
                    </div>
                @else
