...
@section('content')
    ...
    <div class="order-details-area mb-0">
        <div class="container-fluid8 mb-4">
            <div class="row">
                <div class="col-lg-6 col-sm-6 mb-4">
                    <div class="add-new-orders">
                        <a href="{{route('merchant.store.shop',['subdomain'=>$subdomain])}}" target="_blank" class="new-orders">
                            Add New Orders
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li>
                                                <a class="dropdown-item" target="_blank" href="{{route('merchant.store.checkout.order.invoice',['subdomain'=>$subdomain,'id'=>$order->reference])}}">
                                                    Details
