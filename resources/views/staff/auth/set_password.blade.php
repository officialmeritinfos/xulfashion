...
<section class="user-area">
    <div class="container">
        <div class="user-form-content">
            <h3>{{$pageName}}</h3>
            <p>Set-up your account password to proceed</p>

            <form class="user-form" id="login" method="post" action="{{route('staff.staff.setup.password.process')}}">
                <div class="row">
                    <div class="col-md-12 col-12" style="display: none;">
                        <div class="form-group">
                            <label>Email</label>
                            <input class="form-control" type="password" name="email" value="{{$email}}"
                    ...
                    <div class="col-md-12 col-12" style="display: none;">
                        <div class="form-group">
                            <label>Token</label>
                            <input class="form-control" type="password" name="token" value="{{$token}}"
                                   placeholder="Enter your password">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <p class="create">Back to Login Page
                            <a href="{{route('staff.login')}}">Sign in</a>
                        </p>
                    </div>
