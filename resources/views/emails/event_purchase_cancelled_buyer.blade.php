...
<div class="container">
    ...
    <div class="content">
        ...
        <p>
            We regret to inform you that your recent purchase for <span class="highlight">{{ $event->title }}</span> made on <span class="highlight">{{ $purchase->created_at->format('d M Y, h:i A') }}</span> has been cancelled.
            This is because payment was not received within the required 48-hour period.
        </p>
        <p>
