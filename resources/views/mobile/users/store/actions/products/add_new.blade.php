...
@endpush
    ...
    <div class="container-fluid mt-4">
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <form id="basicSettings" method="post" action="{{ route('mobile.user.store.catalog.products.new.process') }}" enctype="multipart/form-data">
                    <div class="row g-4">
                        ...
                        <div class="col-6">
                            ...
                            <input type="number" class="form-control" id="inputTitle" name="comparePrice" step="0.01" value="1">
                        </div>
                        <!-- Price -->
                        <div class="col-6">
                            <label for="inputTitle" class="form-label">
                            ...
                            <input type="number" class="form-control" id="inputTitle" name="sellingPrice" step="0.01" value="0">
                        </div>
                        <!-- Quantity -->
                        <div class="col-12">
                            <label for="inputTitle" class="form-label">
                            ...
                            <input type="number" value="0" class="form-control" id="inputTitle" name="qty">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control editor" id="description" name="description" rows="4"></textarea>
                        </div>

                        <!-- Specifications -->
                        <div class="col-12">
                            <label class="form-label">Product Specifications <sup class="text-danger">*</sup></label>
                            <textarea class="form-control editor" id="description" name="specifications" rows="4"></textarea>
                        </div>

                        <!-- Features -->
                        <div class="col-12">
                            <label class="form-label">Product Features <sup class="text-danger">*</sup></label>
                            <textarea class="form-control editor" id="description" name="features" rows="4"></textarea>
                        </div>

                        <div class="col-12 row mb-2 mt-2">
                            <label class="form-label">Product Size Variations</label>
                            <div class="sizeVariations"></div>
                            <div>
                                <button class="btn theme-btn w-100 mt-1 btn-auto addSizeVariation" role="button" type="button">
                                    Add size variants
                                </button>
                            </div>
                        </div>
                        <div class="col-12 row">
                            <label class="form-label">Product Color Variations</label>
                            <div class="colorVariations"></div>
                            <div>
                                <button class="btn theme-btn w-100 mt-1 btn-auto addColorVariation" role="button" type="button">
                                    Add color variants
                                </button>
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="stockAlert" value="1">
                        ...
                        <div class="col-md-12" id="alertQuantity">
                            ...
                            <input type="number" class="form-control" id="inputTitle" name="alertQuantity" value="0">
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="file-upload">
                                <input type="file" id="productFiles" accept="image/*" multiple onchange="previewProductImages(event)" name="file[]">
                        ...
                        <div class="col-md-12" >
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" value="1" name="addAnother" id="addAnother">
