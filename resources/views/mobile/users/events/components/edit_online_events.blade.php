<form class="theme-form profile-setting" action="{{route('mobile.user.events.edit.online.process')}}" method="post" id="basicSettings"
    ...
    <div class="form-group d-block mb-3">
        <label for="inputusernumber" class="form-label">
            Organizer<sup>
                <i class="fa fa-info-circle" data-bs-toggle="tooltip"
                   title="Who is the organizer?"></i> <span class="text-danger">*</span>
            </sup>
        </label>
        <div class="form-input">
    ...
    <div class="form-group d-block">
        <label for="inputusernumber" class="form-label">Event Platform<sup class="text-danger">*</sup></label>
        <div class="input-group mb-3">
