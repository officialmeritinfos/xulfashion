...
<form class="theme-form profile-setting" action="{{route('mobile.user.events.ticket.group.process',['event'=>$event->reference])}}"
            ...
            <div class="boxed-check-group boxed-check-primary row">
                <div class="col-md-4 mt-2 col-4" data-bs-toggle="tooltip" title="Free">
                    <label class="boxed-check">
                        <input class="boxed-check-input" type="radio" name="ticketKind" value="1" checked>
    ...
    <div class="recurringComponents">
        ...
        <div class="form-group d-block">
            ...
            <div class="input-group mb-3">
                ...
                <input type="number" class="form-control" placeholder="2" aria-label="2" name="quantity" value="0" min="1">
            </div>
        </div>
    </div>
    ...
    <div class="form-group d-block mb-3">
        ...
        <div class="form-input">
            <input type="number" class="form-control" id="inputusernumber" placeholder="4" name="groupSize" min="2" value="2"/>
    ...
    <div class="priceComponent" style="display: none;">
        ...
        <div class="form-group d-block">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" value="{{$event->currency}}" aria-label="2" name="currency" readonly>
