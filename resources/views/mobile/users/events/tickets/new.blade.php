...
@section('content')
    ...
    <div class="container mt-4">
        ...
        @includeWhen($type=='single','mobile.users.events.tickets.components.new_single_ticket')
        @includeWhen($type!='single','mobile.users.events.tickets.components.new_group_ticket')
