    ...
    <section class="section-b-space mt-2">
        <div class="custom-container">
            <div class="terms-Conditions">
                ...
                <p>
                    This Ad Posting Policy governs the submission, review, approval, and display of advertisements ("ads") by merchants on the {{ $siteName }} platform.
                    By submitting an ad, merchants agree to comply with the terms set forth in this policy. {{ $siteName }} reserves the right to modify these guidelines at any time without prior notice.
                </p>
                ...
                <ul>
                    <li>Each merchant is <strong>limited to {{ config('app.numberOfAdPerDay') }} ad posts per day</strong>.</li>
                ...
                <p>Merchants may appeal rejected ads through {{ $siteName }} Customer Support.</p>

                <h2 class="mt-4">6. Featured & Boosted Ads</h2>
                <ul>
                    <li>{{ $siteName }} may select high-quality ads for featured placement.</li>
                ...
                <p>{{ $siteName }} reserves the right to modify this policy at any time. Merchants are responsible for reviewing updates regularly.</p>

                <h3 class="mt-5 text-center">Need Help?</h3>
                <p class="text-center">For inquiries or support, please contact <a href="{{ route('mobile.user.help') }}">{{ $siteName }} Customer Support</a>.</p>
