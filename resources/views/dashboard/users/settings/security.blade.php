...
@section('content')
    ...
    <div class="submit-property-area">
        <div class="container-fluid">
            <form class="submit-property-form col-md-8 mx-auto" id="passwordUpdate" method="post" action="{{route('user.settings.security.password.update')}}">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control form-control-lg password" placeholder="Enter your new password" name="newPassword">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control form-control-lg password" placeholder="Repeat your new password" name="newPassword_confirmation">
                        </div>
                    </div>
                    <div class="col-12">
    ...
    <div class="submit-property-area mt-24 mb-24" style="margin-bottom: 5rem;">
        <div class="container-fluid">
            <form class="submit-property-form col-md-8 mx-auto" id="twoFactors" method="post" action="{{route('user.settings.security.2fa.update')}}">
