...
@section('content')
    ...
    <div class="submit-property-area">
        <div class="container-fluid">
            <form class="submit-property-form" id="processForm" action="{{route('user.stores.coupons.edit.process',['id'=>$coupon->reference])}}" method="post">
                <div class="row g-3">
                    <div class="col-md-12">
                        <label for="inputTitle" class="form-label">Coupon Code<sup class="text-danger">*</sup></label>
                        <input type="text" class="form-control" id="inputTitle" name="name" value="{{$coupon->code}}">
                    </div>
                    ...
                    <div class="col-md-6 price">
                        ...
                        <input type="text" class="form-control" id="price" placeholder="discount" name="discount" value="{{$coupon->discount}}">
                    </div>
                    <div class="col-md-12 mt-3">
                        <div class="form-check">
                            <input class="form-check-input" value="1" type="checkbox" id="useLimit"
                                   name="useLimit" {{($coupon->limitedByUse==1)?'checked':''}}>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="form-check">
                            <input class="form-check-input" value="1" type="checkbox" id="couponEnd"
                                   name="couponEnd" {{($coupon->deactivateByDate==1)?'checked':''}}>
                    ...
                    <div class="col-12 text-center mt-3">
                        <button type="submit" class="default-btn submit">Update Coupon</button>
                    </div>
                </div>
            </form>
        </div>
