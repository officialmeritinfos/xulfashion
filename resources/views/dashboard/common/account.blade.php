                    ...
                    <div class="col-lg-4">
                        <div class="mb-24">
                            <div class="emmeli-bg">
                                ...
                                <p>
                                    Some Tutors opt-in to be paid through {{$siteName}}, and for that reason,
                                    you need to fund your account every month to cover for the salary.
                                    <br>
                                    <b>NOTE:</b> If your account balance is less than the total amount to pay for a month,
                                    the service of the hired tutor(s) will be suspended until your account gets funded again.
                                </p>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single-today-card d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <span class="today">
                                            Main Balance <i class="ri-information-fill" data-bs-toggle="tooltip"
                                                            title="This account needs to be funded at all time to pay for your staff salary"></i>
                                        </span>
                                        <h6>
                                            <span style="word-break: break-word;">
                                                {{$user->mainCurrency}} {{number_format($user->accountBalance,2)}}
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single-today-card d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <span class="today">
                                            Pending Balance <i class="ri-information-fill" data-bs-toggle="tooltip"
                                                            title="This account holds all funded amount pending their disbursal to the appropriate tutors."></i>
                                        </span>
                                        <h6>
                                            <span style="word-break: break-word;">
