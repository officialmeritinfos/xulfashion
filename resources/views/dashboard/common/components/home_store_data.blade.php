            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-today-card d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h6>{{$store->currency}} {{number_format($injected->fetchTotalRevenue($store),2)}}</h6>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-today-card d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h6>{{$store->currency}} {{number_format($injected->fetchTodayMoney($store),2)}}</h6>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-today-card d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h6>{{$store->currency}} {{number_format($injected->fetchSalesOfWeek($store),2)}}</h6>
                    </div>
        ...
        <div class="table-responsive" data-simplebar>
            <table class="table align-middle mb-0">
                ...
                <tr>
                    ...
                    <td>
                        <a href="order-details.html" class="read-more">
                            View Details
