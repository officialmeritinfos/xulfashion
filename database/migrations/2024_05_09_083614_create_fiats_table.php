...
class CreateFiatsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('fiats', function (Blueprint $table) {
            ...
            $table->string('internationalFee', 150)->default('3.9');
            $table->string('localFee', 150)->default('1.5');
            ...
            $table->string('toConversionCharge', 100)->default('1');
            ...
            $table->string('usdRate', 100)->nullable();
