...
class CreateFiatsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('fiats', function (Blueprint $table) {
            ...
            $table->string('ticketAmountToAddToCharge', 100)->default('2500')->comment("this is the amount which when below it, the fixed charge is added to the cost instead of debiting it from amount.");
